...
var ZoomRecordingSetting = (function () {
  ...
  function init(opts) {
    ...
    return {
      ...
      * @param {Function} onCloudRecordingStorageInfo The event of recording settings.
      ...
      * @param {String} zn_szPath Specify the path to save the recording file.
      ...
      * @return {Boolean} true indicates the user has the privilege.
      */
      ...
      * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
      * @note If the return value is SDKERR_SUCCESS, onCloudRecordingStorageInfo() will be triggered after the information has been retrieved.
      */
      ...
      * @return {String} The recording management URL.
      */
      ...
      *   - bCan: true indicates the recording management URL can be retrieved. false not. It validates only when the return value is SDKERR_SUCCESS.
      */
