...
var ZoomDirectShareHelper = (function () {
  ...
  function init(opts) {
    ...
    /**
      ...
      * @param {String} status Specifies the status of direct sharing.
    ...
    return {
       ...
       * @return {Number} If it is enabled to start the direct sharing, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
       ...
       * @return {Boolean} true indicates that the direct sharing is in progress.
       */
