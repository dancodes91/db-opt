...
var ZoomVideoSetting = (function () {
  ...
  function init(opts) {
    ...
    /**
      ...
      @param {Array} newCameraList The new list of all camera devices plugged into the computer. Each item in the array is an ICameraInfo object with properties:
    ...
    */
    ...
    return {
      ...
      * @return {Array} If the function succeeds, the return value is the camera device list. Otherwise returns null. Each item in the array is an ICameraInfo object with properties:
      *   - deviceId: Camera device ID
      *   - deviceName: Camera device name
      *   - isSelected: Whether the current device is selected to use
      */
      ...
      */
      Checking_IsFaceBeautyEffectEnabled: function () {
        if (_addon) {
      ...
      * @param {Number} encodeType {@link ZoomSDKVideoHardwareEncodeType} 
      * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
      */
