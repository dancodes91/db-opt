  ...
  */
  function init(opts) {
    ...
    return {
       ...
       * @return {Number} If the function succeeds, the return value is the current meeting number. Otherwise returns ZERO(0).
       */
       ...
       * @return {String} If the function succeeds, the return value is the current meeting topic. Otherwise returns an empty string of length ZERO(0).
       */
       ...
       * @method GetMeetingID
       * @return {String} If the function succeeds, the return value is the current meeting ID. Otherwise returns an empty string of length ZERO(0).
       */
       ...
       * @return {Number} If the function succeeds, the return value is the current meeting type.
       */
       ...
       * @return {String} If the function succeeds, the return value is the email invitation template. Otherwise returns null.
       */
       ...
       * @return {String} If the function succeeds, the return value is the meeting title. Otherwise returns null.
       */
       ...
       * @return {String} If the function succeeds, the return value is the URL of invitation. Otherwise returns null.
       */
       ...
       * @return {String} If the function succeeds, the return value is the host tag. Otherwise returns null.
       */
