...
var ZoomAudioSetting = (function () {
   ...
   * @param {Function} onComputerMicDeviceChanged Notification of the SDK detects that the computer mic devices have been changed.
   * @param {Function} onComputerSpeakerDeviceChanged Notification of the SDK detects that the computer speaker devices have been changed.
   * @param {Function} onDefaultMicDeviceChanged Notification of the user that a microphone device is selected.
   * @param {Function} onDefaultSpeakerDeviceChanged Notification of the user that a speaker device is selected.
  ...
  function init(opts) {
    ...
    */
    ...
    return {
      ...
      * @return {Array} If the function succeeds, the return value is the mic device list. Otherwise returns null.
      *   - deviceId: The microphone device ID
      *   - deviceName: The microphone device name
      *   - isSelected: Whether the current device is selected to use
      */
      ...
      * @return {Array} If the function succeeds, the return value is the speaker device list. Otherwise returns null.
      *   - deviceId: The speaker device ID
      *   - deviceName: The speaker device name
      *   - isSelected: Whether the current device is selected to use
      */
      ...
      * @return {Number} The echo cancellation level {@link ZoomSDKEchoCancelLationLevel}
      */
      ...
      * @return {Number} If the function succeeds, the return value is the current volume of the mic.
      */
      ...
      * @return {Number} If the function succeeds, the return value is the current volume of the speaker.
      */
