...
var ZoomMeetingConfiguration = (function () {
   ...
   * @param {Function} onUserConfirmToStartArchive Callback event when joining a meeting if the admin allows the user to choose to archive the meeting.
  ...
  function init(opts) {
    ...
    return {
      ...
      /**
      * Sets the visibility of the INVITE button in the panelist action bar during the meeting. Default value: true.
      * @method MeetingConfig_EnableInviteButtonOnMeetingUI
      * @param {Boolean} bEnable true indicates to display the button. Otherwise, false.
      * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
      * @note The user will receive the onInviteBtnClicked() callback event when he clicks the INVITE button. If the callback event is not handled, the SDK will pop up a ZOOM custom invitation dialog. The user will receive the onZoomInviteDialogFailed() callback event if the dialog box is failed to display.
      */
      ...
      /**
      * Sets the position of the floating video window when sharing.
      ...
      */
      ...
      /**
      * Sets the visibility of the toolbar at the bottom of the meeting window. Default value: true.
      * @method MeetingConfig_SetBottomFloatToolbarWndVisibility
      * @param {Boolean} bShow true indicates to enable the feature to display always the toolbar at the bottom. Otherwise, false.
      * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
      */
      ...
      /**
      * Sets the visibility of the sharing toolbar. Default value: true.
      * @method MeetingConfig_SetSharingToolbarVisibility
      * @param {Boolean} bShow true indicates to enable the display sharing toolbar. Otherwise, false.
      * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
      ...
      */
      ...
      /**
       * Sets the position of the primary view meeting window.
      ...
      * @param {Boolean} bDisable true indicates to hide the dialog box. Otherwise, false.
      * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
      */
      ...
      * @param {Boolean} bDisable true indicates to hide the dialog box of wrong password. Otherwise, false.
      * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
      ...
      * @param {Boolean} bEnable true indicates to end the other ongoing meetings. Otherwise, false.
      * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
      */
      ...
      /**
       * Sets if it is able to switch between the full screen mode and normal mode by double-click. Default value: true.
       * @method MeetingConfig_EnableLButtonDBClick4SwitchFullScreenMode
       * @param {Boolean} bEnable true indicates to switch. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
      ...
      /**
       * Sets the visibility of the floating video window when sharing in the meeting. Default value: true.
       * @method MeetingConfig_SetFloatVideoWndVisibility
       * @param {Boolean} bShow true indicates to display the floating video window. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
       ...
       * @param {Boolean} bEnable true indicates to auto-adjust the volume of the speaker. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       ...
       * @param {Boolean} bEnable true indicates to auto-adjust the volume of the mic. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
      ...
      /**
       * Sets if it is able to limit the length of meeting ID. Default: false.
       * @method MeetingConfig_EnableLengthLimitationOfMeetingNumber
       * @param {Boolean} bEnable true indicates to limit the length of meeting ID. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
      ...
      /**
       * Sets if it is able to share IOS device. Default: false.
       * @method MeetingConfig_EnableShareIOSDevice
       * @param {Boolean} bEnable true indicates to enable to share. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
      ...
      /**
       * Sets if it is able to share white board. Default: true.
       * @method MeetingConfig_EnableShareWhiteBoard
       * @param {Boolean} bEnable true indicates to enable to share on the white board. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
      ...
      /**
       * Sets whether to forbid multi-share. Default: false.
       * @method MeetingConfig_ForceDisableMultiShare
       * @param {Boolean} bDisable true indicates to forbid multi-share. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
       ...
       * @param {Boolean} bEnable true indicates to enable the zoom docs feature. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
      ...
      /**
       * Sets the visibility of the local recording convert progress bar dialog. Default: true
       * @method MeetingConfig_EnableLocalRecordingConvertProgressBarDialog
       * @param {Boolean} bShow true indicates to show the dialog box. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
      ...
      /**
       * Sets the visibility of the dialog box when receiving the request of remote control during the meeting. Default value: true.
       * @method MeetingConfig_EnableApproveRemoteControlDlg
       * @param {Boolean} bEnable true indicates to display the dialog box. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       * @note If it is false, the user can deal with this request in the onRemoteControlStatus() callback event sent by SDK when receiving the request of the remote control and then enters the sharing status at the end of callback event.
       */
      ...
      /**
       * Sets the visibility of the dialog box when the request of the remote control is refused. Default value: true.
       * @method MeetingConfig_EnableDeclineRemoteControlResponseDlg
       * @param {Boolean} bEnable true indicates to display the dialog box. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       * @note If it is false, the user can deal with this request in the onRemoteControlStatus() callback event sent by SDK when receiving the decline request of the remote control and then exists the sharing status at the end of callback event.
       */
      ...
      /**
       * Sets the visibility of the LEAVE MEETING button on the pop-up dialogue box when the host leaves the meeting. Default value: true.
      ...
      /**
       * Sets the visibility of the Video button in the toolbar during the meeting. Default value: true.
      ...
      /**
       * Sets the visibility of the buttons to enter or exit the full screen in the meeting window. Default value: true.
      ...
      /**
       * Sets if it is able to handle the event with user's own program by clicking START SHARE button in the meeting. Default value: false.
       * @method MeetingConfig_RedirectClickShareBTNEvent
       * @param {Boolean} bEnable true indicates to deal with the event with user's own program. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       * @note The SDK won't enable the share if the user calls this function and sets to convert. The user will deal with the subsequent logic after receiving the onStartShareBtnClicked() callback event.
       */
      ...
      /**
       * Sets if it is able to handle the event with user's own program by clicking END MEETING button in the meeting. Default value: false.
       * @method MeetingConfig_RedirectClickEndMeetingBTNEvent
       * @param {Boolean} bEnable true indicates to handle with user's own program. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       * @note The SDK won't end the meeting if the user calls this function and set to convert. The user will deal with the subsequent logic after receiving the onEndMeetingBtnClicked() callback event.
       */
       ...
       * @param {Boolean} bEnable true indicates to handle the reminder message with user's own program. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       * @note The SDK will trigger the onFreeMeetingEndingReminderNotification() callback event when the meeting is over if the user calls this function to set the conversion.
       */
      ...
      /**
       * Sets if it is able to handle the event with SDK user's own program by clicking CUSTOM LIVE STREAM button in the meeting. Default value: false.
       * @method MeetingConfig_RedirectClickCustomLiveStreamMenuEvent
       * @param {Boolean} bEnable true indicates to handle with user's own program. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       * @note If the user calls this function to convert, the SDK will trigger the onCustomLiveStreamMenuClicked() instead of jumping to the live video page when clicking on the custom live stream, then deal with the subsequent logic.
       */
      ...
      /**
       * Sets if it is able to handle the event with SDK user's own program by clicking PARTICIPANT LIST button in the meeting. Default value: false.
       * @method MeetingConfig_RedirectClickParticipantListBTNEvent
       * @param {Boolean} bEnable true indicates to handle with user's own program. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       * @note The list won't unfold by clicking participant list button if the user calls this function to set to convert. The SDK will trigger the onParticipantListBtnClicked(), and the user shall deal with the subsequent logic himself.
       */
      ...
      /**
       * Sets if it is able to handle the event with SDK user's own program by clicking Closed Caption button in the meeting. Default value: false.
       * @method MeetingConfig_RedirectClickCCBTNEvent
       * @param {Boolean} bEnable true indicates to handle with user's own program. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       * @note If the user calls this function to convert, the SDK will trigger the onCCBTNClicked(), and the user shall deal with the subsequent logic himself.
       */
      ...
      /**
       * Sets if it is able to handle the warning message with SDK user's own program in the meeting. Default value: None.
       * @method MeetingConfig_RedirectMeetingWarningMsg
       * @param {Boolean} bRedirectBadNetwork
       * @param {Boolean} bRedirectWarnHighCPU
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       * @note If the user calls this function to convert, the SDK will trigger the onMeetingStatisticsWarningNotification(), and the user shall deal with the subsequent logic himself.
       */
      ...
      /**
       * Sets if it is able to temporarily show tooltip of the button in the toolbar of the meeting and user can close it by click the "x". Default value: true.
       * @method MeetingConfig_EnableToolTipsShow
       * @param {Boolean} bEnable true indicates to enable to show the tooltip in the meeting. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
      ...
      /**
       * Sets if it is able to retrieve the permission of host (when the original host gives up the host permission). Default value: true.
       * @method MeetingConfig_EnableClaimHostFeature
       * @param {Boolean} bEnable true indicates that he can retrieve the permission of host. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
      ...
      /**
       * Sets the visibility of the dialog box of choosing audio when joining the meeting. Default value: false.
       * @method MeetingConfig_EnableAutoHideJoinAudioDialog
       * @param {Boolean} bEnable true indicates to hide the dialog box of choosing audio when joining the meeting. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
      ...
      /**
       * Sets if it is able to display the preview window of the Meeting Controls on the task bar during sharing. Default value: false.
      ...
      /**
       * Sets if it is able to enable split screen during the meeting. Default value: false.
       * @method MeetingConfig_DisableSplitScreenModeUIElements
       * @param {Boolean} bEnable true indicates to disable the split screen. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
      ...
      /**
       * Sets the visibility of the SHARE COMPUTER SOUND check-box in the sharing window. Default value: true.
       * @method MeetingConfig_SetShowAudioUseComputerSoundChkbox
       * @param {Boolean} bEnable true indicates to display. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
      ...
      /**
       * Sets the visibility of PHONE CALL tab in the audio dialog box when joining the meeting. Default value: true.
       * @method MeetingConfig_SetShowCallInTab
       * @param {Boolean} bEnable true indicates to display the tab. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
      ...
      /**
       * Sets the visibility of CALL ME tab in the audio dialog box when joining the meeting. Default value: true.
       ...
       * @param {Boolean} bEnable true indicates to remove. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
       ...
       * @param {Boolean} bEnable true indicates no prompt. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
      ...
      /**
       * Sets the visibility of the SWITCH TO SINGLE PARTICIPANT SHARE dialog box when multiple participants are sharing and the user try to change the setting to single share. Default: TURE.
       * @method MeetingConfig_EnableShowShareSwitchMultiToSingleConfirmDlg
       * @param {Boolean} bEnable true indicates to show dialog box if the multishare option is changed. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       * @note If the dialog is disabled to show, you will retrieve onMultiShareSwitchToSingleShareNeedConfirm callback event.
       */
      ...
      /**
       * Sets the visibility of the REMAINING MEETING TIME button in the meeting. Default: false.
       * @method MeetingConfig_DisableFreeMeetingRemainTimeNotify
       * @param {Boolean} bEnable true indicates to hide the button when the free meeting need be reminded. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       * @note If the button is disabled to show, you will retrieve onFreeMeetingRemainTime callback event.
       */
      ...
      /**
       * Sets whether to display the button CHAT and menu item. Default is displaying.
       * @method MeetingConfig_HideChatItemOnMeetingUI
       * @param {Boolean} bEnable true indicates hiding. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
      ...
      /**
       * Sets whether to display the button RECORD and menu item. Default is displaying.
      ...
      /**
       * Sets whether to display the button UPGRADE when prompt the tooltip of free meeting counts down. Default is displaying.
      ...
      /**
       * Sets the visibility of some specified tabs in the invite dialog. Default: Show all the content.
       * @method MeetingConfig_SetShowInviteDlgTabPage
       * @param {Number} tabPage Specify a tab page.
       * @param {Boolean} bShow true indicates to display the tab. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
      ...
      /**
       * Sets the visibility of some specified tabs in the Room System invitation dialog. Default: show all the content.Default: show all the content.
       * @method MeetingConfig_SetShowH323SubTabPage
       * @param {Number} tabPage Specify a tab.
       * @param {Boolean} bShow true indicates to display the tab. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
      ...
      /**
       * Sets the visibility of Switch Camera button on 2nd camera share window,Default: true.
       * @method MeetingConfig_HideSwitchCameraButton
       * @param {Boolean} bEnable true indicates to hide the Switch Camera button. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
       ...
       * @param {Boolean} bEnable true indicates to hide. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
       ...
       * @param {Boolean} bEnable true indicates to display the dialog box to input password. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       * @note If it is disabled, the SDK will trigger onInputMeetingPasswordAndScreenNameNotification() callback event when the user is asked to re-enter the password, then the user shall deal with the subsequent logic.
       */
       ...
       * @param {Boolean} bEnable true indicates to display the dialog box to input the screen name which is to be displayed in the meeting. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       * @note If it is false, the SDK will trigger onInputMeetingPasswordAndScreenNameNotification() callback event when the user is asked to re-enter the screen name, then the user shall deal with the subsequent logic.
       */
       ...
       * @param {Boolean} bEnable true indicates to redirect. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       * @note If it is true, the SDK will trigger the onWebinarNeedRegisterNotification() callback event.
       */
       ...
       * @param {Boolean} bEnable true indicates to redirect. Otherwise, false. If it is true, the SDK will trigger the onEndOtherMeetingToJoinMeetingNotification().
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       * @note This function doesn't work if the EnableAutoEndOtherMeetingWhenStartMeeting(true) is also called. If redirect successfully, the SDK will trigger the onEndOtherMeetingToJoinMeetingNotification() callback event.
       */
       ...
       * @param {Boolean} bShow true indicates to display. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
       ...
       * @return {Number} If the function succeeds, the return is defined in: {@link RequiredInfoType}
       */
       ...
       * @return {Boolean} If the function succeeds, the return value is true. Otherwise, this function returns an error.
       ...
       * @return {String} If the function succeeds, the return value is an URL.
       */
       ...
       * @param {Boolean} bRedirect true indicates to display. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
       ...
       * @param {Boolean} bRedirect true indicates to redirect. Otherwise, false. 
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
       ...
       * @param {Boolean} bRedirect true indicates to handle with user's own program. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       * @note If the user calls this function to convert, the SDK will trigger the onAudioBtnClicked(AudioBtnClickedCallbackInfo info), and the user shall deal with the subsequent logic himself. 
       */
       ...
       * @param {Boolean} bRedirect true indicates to handle with user's own program. Otherwise, false.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       * @note If the user calls this function to convert, the SDK will trigger the onAudioMenuBtnClicked(), and the user shall deal with the subsequent logic himself.
       */
       ...
       * @param {Boolean} bEnable true indicates to display the link. Otherwise, false.
       * @return {Boolean} If the function succeeds, the return value is true. Otherwise, this function returns an error.
       */
       ...
       * @return {Boolean} true if can modify default display name. Otherwise, false.
       */
       ...
       * @param {Boolean} bStartArchive true indicates start the archive when joining the meeting, false indicates do not start the archive when joining the meeting.
       * @return {Number} If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise, this function returns an error.
       */
