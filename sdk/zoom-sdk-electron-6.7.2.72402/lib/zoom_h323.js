  ...
  function init(opts) {
    ...
    return {
      ...
      */
       ...
       * @return {Array} If the function succeeds, the return value is the pointer to the list of the call-in number. Otherwise, this function returns an error, the return value is null.
       */
